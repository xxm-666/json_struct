...
/**
 * @brief Lazy query generator with full JSONPath support
 * 
 * This version supports all JSONPath features:
 * - Filter expressions [?(...)]
...
public:
     ...
     */
    LazyQueryGenerator(const JsonFilter* filter, const JsonValue* root, 
